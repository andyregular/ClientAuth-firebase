...
const SignIn: React.FC = () => {
  ...
  const { signIn, loading, sendMagicLink } = useAuth();
  ...
  const handlePasswordlessSignIn = async () => {
    try {
      ...
      console.error('Error signing in:', error);
      setError(
        error.message || "Failed to sign in. Please check your email and try again."
      );
    }
  };
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSignIn}>
                ...
                <button onClick={() => handlePasswordlessSignIn()} className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 dark:border-strokedark dark:bg-meta-4 mt-6">
