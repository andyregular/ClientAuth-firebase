...
const SignIn: React.FC = () => {
  ...
  const handleLoginMethod = () => {
    setEasyLogin(prevState => !prevState)
  };
  ...
  const handleEasySignIn = (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();

    sendSignInLinkToEmail(auth, email, {
      url: 'https://alpha-app-validate.vercel.app/auth/signin',
...

              {
                !easyLogin ?
                  <form onSubmit={handleSignIn}>
                    ...
                    <div className='flex items-center justify-center gap-3 text-black text-sm'>
                      <span>------</span>
                      <span>OR</span>
                      <span>------</span>
                    </div>

                    <button onClick={handleLoginMethod} className="flex w-full text-black font-semibold underline justify-center hover:text-blue-500 mt-5">
                      {
                        !easyLogin ?
                  ...
                  :
                  <form onSubmit={handleEasySignIn}>
                    <div className="mb-4">
                      <label className="mb-2.5 block font-medium text-black dark:text-white">
                        Email
                      </label>
